...
Code above is licensed under the [MIT <https://brianmhunt.mit-license.org/>](https://brianmhunt.mit-license.org/) license.


# See also

- [gae-taggable-mixin for db.Model](https://github.com/bubenkoff/gae-taggable-mixin)
- [Nick's Blog: Blogging on App Engine, part 5: Tagging](https://blog.notdot.net/2009/10/Blogging-on-App-Engine-part-5-Tagging)
