...
The **promises** of simplified aggregation of our scripts and automatic compilation of Coffeescript was luring. Unfortunately, RequireJS was such a time sink that I wrote [Yet Another Module Definition Optimizer](https://github.com/brianmhunt/yamdo) between debugging fits. Thankfully there was a ready-made solution: **Browserify**.
